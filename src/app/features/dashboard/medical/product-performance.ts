...
import { medicalDashboardData } from '../../../core/data/category-performance-data';
...
@Component({
  ...
  template: `
    <app-category-performance [data]="data" [transactions]="allTransactions" [businessUnit]="'Medical'" />
...
export class ProductPerformance {
  ...
  transactions = applyScope(this.allTransactions, { businessUnit: 'Medical' });
